...
if my_file.is_file():
    ...
    model.save_weights('results/'+name+".h5")
    print("Saved model to disk")
    # plot history
    pyplot.figure(figsize=(800/my_dpi, 600/my_dpi), dpi=my_dpi)
    pyplot.plot(history.history['loss'], label='train')
    pyplot.plot(history.history['val_loss'], label='test')
    pyplot.legend()
    pyplot.savefig('results/'+name+"_train.png", dpi=my_dpi * 10)
    pyplot.show()
...
pyplot.figure(figsize=(800/my_dpi, 600/my_dpi), dpi=my_dpi)
pyplot.plot(test_X[:, -1], label="real")
pyplot.plot(yhat, label="predict")
pyplot.legend()
pyplot.savefig('results/'+name+"_predict.png", dpi=my_dpi * 10)
pyplot.show()